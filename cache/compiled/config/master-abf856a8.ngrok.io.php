...
return [
    ...
    'checksum' => '2074eb8cc57be684706d85738d979875',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'plugins/webmention' => [
                'file' => 'user/config/plugins/webmention.yaml',
                'modified' => 1495258176
            ],
            'security' => [
        ...
        'user/plugins' => [
            ...
            'plugins/webmention' => [
                'file' => 'user/plugins/webmention/webmention.yaml',
                'modified' => 1495370987
            ]
        ]
    ],
    'data' => [
        'plugins' => [
            ...
            'feed' => [
                'enabled' => true,
                'limit' => 10,
                'description' => 'Jeremy Cherfas Posts',
                'lang' => 'en-us',
                'length' => 500
            ],
            'form' => [
